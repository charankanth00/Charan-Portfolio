		...
		<section id="skills" className="py-16 px-4 max-w-4xl mx-auto">
			...
			<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
				{skills.map((skill, index) => {
					// Show details always on mobile, or on hover for desktop
					const showDetails = isMobile || hoveredSkill === index;
					return (
						<motion.div
							key={skill.name}
						...
						>
							...
							>
								...
								{/* Skill level - always visible on mobile, on hover for desktop */}
								<motion.div
								...
								>
									...
									<div className="w-full bg-gray-200 rounded-full h-2">
										<motion.div
											...
											initial={{ width: 0 }}
											animate={{
												width: showDetails ? `${skill.level}%` : 0,
											}}
